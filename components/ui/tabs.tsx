...
export function Tabs({
  ...
  return (
    <div className={cn("w-full", className)}>
      {/* Scrollable wrapper — prevents tab list overflow on narrow viewports */}
      <div className="overflow-x-auto scrollbar-none">
        <div
          ...
          className={cn(
            ...
            isPill      && "gap-1 p-1 rounded-[var(--radius-lg)] bg-[var(--bg-surface-2)]",
            isOutline   && "gap-1 border border-[var(--border-default)] rounded-[var(--radius-lg)] p-1"
          )}
        >
          {items.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  /* underline variant — inset box-shadow avoids overflow-clipping issues with -mb-px */
                  isUnderline && [
                    "relative rounded-none",
                    isActive
                      ? "shadow-[inset_0_-2px_0_var(--brand-default)] text-[var(--brand-default)]"
                      : "text-[var(--fg-muted)] hover:text-[var(--fg-default)] hover:shadow-[inset_0_-2px_0_var(--border-strong)]",
                  ],
